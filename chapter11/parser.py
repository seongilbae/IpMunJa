# REQUIREMENTS
# init.csv         total instruction list
# /result1/Result_Malware.txt        malware samples IDA analysis result
# /result1/Result_Benign.txt         benign

# OUTPUT
# result.csv               parsing result
...
malware = getResult("Result_Malware.txt")
benign = getResult("Result_Benign.txt")
